import 'package:chariot/src/log/adapter/std.dart';
...
class Logger extends ILogger {
  ...
  ///初始化日志记录器
  Logger({LoggerAdapter adapter, Set<String> levels})
      : _adapter = adapter ?? StdAdapter(),
        _levels = levels ?? DefaultLogLevels;
